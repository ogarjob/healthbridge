...
<div class="modal fade" id="ehealth-modal" tabindex="-1" aria-labelledby="ehealth-modal-label" aria-hidden="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title text-gray-800">Consult with E-health</h3>
                <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                    <i class="ki-duotone ki-abstract-11 fs-2"><i class="path1"></i><i class="path2"></i></i>
                </div>
            </div>
            <div class="modal-body">
                <form action="{{ route('api.ehealth-appointments.store') }}" x-submit>
                    <div class="row">
